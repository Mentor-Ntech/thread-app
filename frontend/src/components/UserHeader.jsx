      ...
      <VStack gap={4} alignItems={"start"}>
         <Flex justifyContent={"space-between"} w={"full"}>
            ...
            <Box>
               ...
               {!user.profilePic && (
                   <Avatar name={user.name} src="https://tinyurl.com/3cmv5592" size={{base: "md", md: "xl"}} />
               )}
         ...
         <Text>
           ...
           {currentUser._id !== user._id && (
                <Link as={RouterLink} >
                <Button 
                 size={"sm"} onClick={handleFollowUnfollow} isLoading={updating}>{following ? "unFollow" : "Follow"}
             </Button>
